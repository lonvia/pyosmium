...
class FileProcessor:
    ...
    def __init__(self, indata: Union[File, FileBuffer, str, 'os.PathLike[str]'],
                 ...
                 thread_pool: Optional[osmium.io.ThreadPool] = None) -> None:
        ...
        self._thread_pool = thread_pool or osmium.io.ThreadPool()
    ...
    def header(self) -> osmium.io.Header:
        ...
        """
        return osmium.io.Reader(self._file, osmium.osm.NOTHING, self._thread_pool).header()
    ...
    def __iter__(self) -> Iterator[OSMEntity]:
        ...
        if self._area_handler is None:
            with osmium.io.Reader(self._file, self._entities, self._thread_pool) as reader:
        ...
        with osmium.io.Reader(self._file, osmium.osm.RELATION, self._thread_pool) as rd:
